...
public class Con {
    ...
    public int sellNow(String pname, String pdetails, int rid, String pprice) {
        String sql = "INSERT INTO `product` (`product_id`, `product_name`, `register_id`, `product_details`, `price`, `product_image`) VALUES (NULL, ?, ?, ?, ?, '');";
        try {
            Connection con = con();
